...
#SBATCH --output=./slurm-logs/Mini-InternVL-Chat-4B-V1-5_pruned_10_50_samples-dist-out.%j
#SBATCH --error=./slurm-errors/Mini-InternVL-Chat-4B-V1-5_pruned_10_50_samples-dist-err.%j
...
python -m torch.distributed.run \
  ...
  --output_dir '${REPO_ROOT}/VLM/InternVL/internvl_chat/ckpt/dist-10/' \
  ...
  2>&1 | tee -a "${REPO_ROOT}/VLM/InternVL/internvl_chat/ckpt/dist-10/training_log.txt"
'