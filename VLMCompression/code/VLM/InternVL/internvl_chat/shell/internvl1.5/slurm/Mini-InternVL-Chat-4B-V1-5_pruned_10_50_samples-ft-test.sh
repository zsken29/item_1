...
#SBATCH --output=./slurm-logs/Mini-InternVL-Chat-4B-V1-5_pruned_10_50_samples-ft-testgpu-out.%j
#SBATCH --error=./slurm-errors/Mini-InternVL-Chat-4B-V1-5_pruned_10_50_samples-ft-testgpu-err.%j
...
python -m torch.distributed.run \
  ...
  --output_dir '${REPO_ROOT}/VLM/InternVL/internvl_chat/ckpt/ft-10-testgpu/' \
  ...
  2>&1 | tee -a "${REPO_ROOT}/VLM/InternVL/internvl_chat/ckpt/ft-10-testgpu/training_log.txt"
'