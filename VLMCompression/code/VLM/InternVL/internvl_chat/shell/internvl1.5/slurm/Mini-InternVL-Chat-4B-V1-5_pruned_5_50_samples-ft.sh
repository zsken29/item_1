...
#SBATCH --output=./slurm-logs/Mini-InternVL-Chat-4B-V1-5_pruned_5_50_samples-ft-out.%j
#SBATCH --error=./slurm-errors/Mini-InternVL-Chat-4B-V1-5_pruned_5_50_samples-ft-err.%j
...
python -m torch.distributed.run \
  ...
  --output_dir '${REPO_ROOT}/VLM/InternVL/internvl_chat/ckpt/ft-5/' \
  ...
  2>&1 | tee -a "${REPO_ROOT}/VLM/InternVL/internvl_chat/ckpt/ft-5/training_log.txt"
'