...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a supported local MLLM on a local subset.")
    ...
    parser.add_argument("--output", default="outputs/reports/internvl_subset/metrics.json")
